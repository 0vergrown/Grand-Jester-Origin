...
public enum ModArmorMaterials implements ArmorMaterial {
    PATCHWORK_CLOAK("patchwork_cloak", 25, new int[] { 3, 8, 6, 3 }, 19,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 2f, 0.1f, () -> Ingredient.ofItems(ModItems.PATCHWORK_CLOAK));
    ...
    public String getName() {
        return GrandJester.MOD_ID + ":" + this.name;
    }
